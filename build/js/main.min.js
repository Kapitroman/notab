...
/* harmony import */ var _modules_use_cookie__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/use-cookie */ "./js/modules/use-cookie.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_use_cookie__WEBPACK_IMPORTED_MODULE_2__["useCookie"])(); // Modules
  // ---------------------------------
...
var useCookie = function useCookie() {
  var modalPanel = document.querySelector('.use-cookie');

  if (!modalPanel) {
    return;
  }

  var buttonCookie = modalPanel.querySelector('.use-cookie__button');

  var clickOkButton = function clickOkButton() {
