...
/* harmony import */ var _modules_form_init_form_validate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/form/init-form-validate */ "./js/modules/form/init-form-validate.js");
/* harmony import */ var _modules_cookie_consent_checker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/cookie-consent-checker */ "./js/modules/cookie-consent-checker.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    // initModals();
    // initCustomSelect();
    Object(_modules_cookie_consent_checker__WEBPACK_IMPORTED_MODULE_2__["cookieConsentChecker"])();
    Object(_modules_form_init_form_validate__WEBPACK_IMPORTED_MODULE_1__["initFormValidate"])();
  });
}); // ---------------------------------
...
/* harmony import */ var _cookie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cookie */ "./js/modules/cookie.js");

var BASE_DURATION = 30;
var cookieElement = document.querySelector('[data-cookies]');
var cookieConsentChecker = function cookieConsentChecker() {
  if (!cookieElement) {
    return;
  }

  var consentCookie = new _cookie__WEBPACK_IMPORTED_MODULE_0__["Cookie"]('has_cookie_consent');

  if (!consentCookie.get('has_cookie_consent')) {
    var cookieBtnElement = cookieElement.querySelector('[data-cookies-consent]');
    cookieElement.classList.add('is-active');
    cookieBtnElement.addEventListener('click', function (evt) {
      evt.preventDefault();
      var cookieDuration = +cookieElement.dataset.cookiesDuration || BASE_DURATION;
